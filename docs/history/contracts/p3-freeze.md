...
依据：`docs/architecture/tech-solution.md` §2.1（active 可传输）/§2.8/§4-P3、`docs/research/overload-20260813-fleet-inventory.md` §4。P1/P2 契约继续有效。

## 模块边界与独占权（本批次）

| 路径 | 独占 owner | 内容 |
|---|---|---|
| `src/pull/**`, `scripts/deploy-devbox.sh`, `scripts/maintenance.sh`（仅 m6 修改）, `launchd/app.overload.pull.plist` | N10 | devbox 拉取器 + 部署脚本 + m6 |
