...
function cfg(host:SourceHost={host:"local",kind:"local"}):ManageConfig{return {enabled:true,agents:["pi"],hosts:[host],lookback_ms:1_000_000,follow_new:true,snapshot:{file_max_bytes:10_000,work_max_bytes:100_000,retain_ms:100},archive_grace_ms:100,snapshot_root:"/tmp/overload-manage-test"};}
